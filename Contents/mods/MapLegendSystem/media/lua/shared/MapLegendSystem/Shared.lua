...
MapLegendShared.COMMANDS = {
    ...
    REQUEST_EDIT_CONTENT = "requestEditContent",
    RECEIVE_EDIT_CONTENT = "receiveEditContent",
    SAVE_EDIT_CONTENT = "saveEditContent",
}
...
MapLegendShared.Utils.createDefaultFile = function(filePath)
    ...
    file:write(
        "<IMAGE:media/textures/Foraging/pinIconAnimals.png,30,45> <SPACE> <GREEN> Active Marker <SPACE> <RGB:1,1,1> Custom location set by admins or events. <LINE>\r\n")
    file:write(
        "<IMAGE:media/textures/Foraging/pinIconUnknown.png,30,45> <SPACE> <ORANGE> Unexplored / Mystery <SPACE> <RGB:1,1,1> Location contains unknown or hidden information. <LINE>\r\n")
    file:write("<INDENT:24><RGB:0.8,0.8,0.8>Visit the area to uncover details or trigger events. <INDENT:0> <BR>\r\n")
    file:write(
        "<IMAGE:media/textures/Foraging/pinIconStones.png,30,45> <SPACE> <RED> Airdrop Zone <SPACE> <RGB:1,1,1> Supply crate has landed at this location. <LINE>\r\n")
    ...
    file:write(
        "<INDENT:16> <RGB:1,0.6,0.6> Pink Markers <SPACE> <RGB:1,1,1> Community or public projects. <INDENT:0> <BR>\r\n")
